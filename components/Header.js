  ...
  const search = (e) => {
   ...
   <header className="sticky top-0 bg-white">
      ...
      <Image 
            ...
            onClick={()  => router.push("/")}
        />
     <form className="flex flex-grow px-6 py-3 ml-10 mr-5 rounded-full shadow-lg max-w-3xl items-center ">
     ...
     <Avatar className="ml-auto" url="https://i.postimg.cc/HWtscG0D/IMG-20201218-141353-004.jpg"/>
      </div>
